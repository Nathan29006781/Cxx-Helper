...
struct Position{
  ...
  //Operators
    friend constexpr Position<R> operator* (Position<R> const &, double);
    friend constexpr Position<R> operator* (double, Position<R> const &);
    friend constexpr Position<R> operator/ (Position<R> const &, double);
    friend constexpr Position<R> operator/ (double, Position<R> const &);
    constexpr bool operator== (Position<R> const & p2) const;
    constexpr bool operator!= (Position<R> const & p2) const;
    constexpr Position<R> operator+ (Position<R> const & p2) const;
    constexpr Position<R> operator- (Position<R> const & p2) const;
...
template <std::floating_point R> 
constexpr Position<R> operator* (Position<R> const & position, double scalar){
  return {position.x*scalar, position.y*scalar, position.angle*scalar};
}
template <std::floating_point R> 
constexpr Position<R> operator* (double scalar, Position<R> const & position){
...
template <std::floating_point R> 
constexpr bool Position<R>::operator== (Position<R> const & p2) const{
...
template <std::floating_point R> 
constexpr Position<R> Position<R>::operator+ (Position<R> const & p2) const{
  return {x + p2.x, y + p2.y, angle + p2.angle};
}
template <std::floating_point R> 
constexpr Position<R> Position<R>::operator- (Position<R> const & p2) const{

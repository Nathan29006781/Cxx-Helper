...
inline constexpr natural permute(natural n, natural r) {return r > n ? 0 : factorial(n)/factorial(n-r);}
inline constexpr natural choose(natural n, natural r) {return r > n ? 0 : permute(n, r)/factorial(r);}
